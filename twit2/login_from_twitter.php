...
/* The user clicked on "Cancel, and return to app" when asked to login at the twitter.com page or the user managed to find this file on his own without first being connected to the twitter.com page */ else {
